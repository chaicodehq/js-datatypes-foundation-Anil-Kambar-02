...
export function whisperChaiOrder(order) {
  ...
  return orderTrim.toLocaleLowerCase();
}
...
export function hasSpecialIngredient(order, ingredient) {
  ...
  let ordertoLower = order.trim().toLocaleLowerCase();
  let ingredtoLower = ingredient.trim().toLocaleLowerCase();

  return ordertoLower.includes(ingredtoLower);
}
